...
<body>
    ...
    <section class="form signup">
      ...
      <form action="#" enctype="multipart/form-data">
        ...
        <div class="field input password">
          ...
          <input type="password" name="password" id="password" minlength="8" placeholder="Enter a password" 
  ...
  function setLange( ) {
    ...
    // this is spanish convert code
     document.querySelector('#password').setAttribute('title',langs[localStorage.getItem('chatBoxLanguage')].hishis)
